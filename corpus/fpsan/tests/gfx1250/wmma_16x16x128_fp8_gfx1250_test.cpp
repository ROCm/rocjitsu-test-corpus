...
FPSAN_WMMA128_TRAITS(WmmaF32Fp8Fp8_128,
                     v64e4m3_native,
                     v64e4m3_native,
                     v8f_native,
                     amdgcn_wmma_f32_16x16x128_fp8_fp8)
FPSAN_WMMA128_TRAITS(WmmaF32Fp8Bf8_128,
                     v64e4m3_native,
                     v64e5m2_native,
                     v8f_native,
                     amdgcn_wmma_f32_16x16x128_fp8_bf8)
FPSAN_WMMA128_TRAITS(WmmaF32Bf8Fp8_128,
                     v64e5m2_native,
                     v64e4m3_native,
                     v8f_native,
                     amdgcn_wmma_f32_16x16x128_bf8_fp8)
FPSAN_WMMA128_TRAITS(WmmaF32Bf8Bf8_128,
                     v64e5m2_native,
                     v64e5m2_native,
                     v8f_native,
                     amdgcn_wmma_f32_16x16x128_bf8_bf8)
FPSAN_WMMA128_TRAITS(WmmaF16Fp8Fp8_128,
                     v64e4m3_native,
                     v64e4m3_native,
                     v8h_native,
                     amdgcn_wmma_f16_16x16x128_fp8_fp8)
FPSAN_WMMA128_TRAITS(WmmaF16Fp8Bf8_128,
                     v64e4m3_native,
                     v64e5m2_native,
                     v8h_native,
                     amdgcn_wmma_f16_16x16x128_fp8_bf8)
FPSAN_WMMA128_TRAITS(WmmaF16Bf8Fp8_128,
                     v64e5m2_native,
                     v64e4m3_native,
                     v8h_native,
                     amdgcn_wmma_f16_16x16x128_bf8_fp8)
FPSAN_WMMA128_TRAITS(WmmaF16Bf8Bf8_128,
                     v64e5m2_native,
                     v64e5m2_native,
                     v8h_native,
