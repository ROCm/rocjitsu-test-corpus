                                 ...
                                 typename Harness<Traits>::CElem*       D)
{
    ...
    load_frags<Traits, Semantics::Native>(A, B, C, lane, a, b, c);
    int  idx = IDX[lane];
    auto d   = fpsan::detail::swmmac_software_16x16x64_16<typename Harness<Traits>::AVec,
...
SWMMAC16_TRAITS(
    SwmmacF32F16_64, v16h_native, v32h_native, v8f_native, amdgcn_swmmac_f32_16x16x64_f16)
SWMMAC16_TRAITS(
    SwmmacF16F16_64, v16h_native, v32h_native, v8h_native, amdgcn_swmmac_f16_16x16x64_f16)
SWMMAC16_TRAITS(
