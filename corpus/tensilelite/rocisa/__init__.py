...
# The ROCm SDK wheel installs the native extension in its TensileLite data
# directory. The launcher adds that directory to PYTHONPATH; extending this
# package path lets the vendored Python shim load the SDK's compiled _rocisa.
