...
static int ab_lane(int row_or_col, int k) { return row_or_col + 16 * ((k >> 2) & 1); }
...
static void stage_operands_mixed(const std::vector<float> &A, const std::vector<float> &B,
...
template <int AFMT, int BFMT>
__global__ void k_f8f6f4(const std::uint32_t *Apack, const std::uint32_t *Bpack, const float *C,
                         float *D) {
...
template <int AFMT, int BFMT, bool MIXED = false> static void run_layout(const char *tag) {
  if (!have_device())
...
TEST(WmmaF8f6f4_128, Bf8Bf8) { run_layout<1, 1>("bf8_bf8"); }
TEST(WmmaF8f6f4_128, Fp6Fp6) { run_layout<2, 2>("fp6_fp6"); }
TEST(WmmaF8f6f4_128, Bf6Bf6) { run_layout<3, 3>("bf6_bf6"); }
TEST(WmmaF8f6f4_128, Fp4Fp4) { run_layout<4, 4>("fp4_fp4"); }
...
TEST(WmmaF8f6f4_128, Fp6Fp4) { run_layout<2, 4>("fp6_fp4"); }
...
TEST(WmmaF8f6f4_128, Fp8Fp6_mixed) { run_layout<0, 2, true>("fp8_fp6"); }
TEST(WmmaF8f6f4_128, Fp4Fp8_mixed) { run_layout<4, 0, true>("fp4_fp8"); }
TEST(WmmaF8f6f4_128, Bf8Fp4_mixed) { run_layout<1, 4, true>("bf8_fp4"); }
TEST(WmmaF8f6f4_128, Fp6Fp8_mixed) { run_layout<2, 0, true>("fp6_fp8"); }
...
__global__ void k_f8f6f4_fpsan(const std::uint32_t *Apack, const std::uint32_t *Bpack,
...
TEST(WmmaF8f6f4_128, Fpsan_Fp6Fp6) { run_fpsan_all<2, 2>("fp6_fp6"); }
TEST(WmmaF8f6f4_128, Fpsan_Bf6Bf6) { run_fpsan_all<3, 3>("bf6_bf6"); }
TEST(WmmaF8f6f4_128, Fpsan_Fp4Fp4) { run_fpsan_all<4, 4>("fp4_fp4"); }
TEST(WmmaF8f6f4_128, Fpsan_Fp6Fp4) { run_fpsan_all<2, 4>("fp6_fp4"); }
...
TEST(WmmaF8f6f4_128, Fpsan_Fp8Fp6_mixed) { run_fpsan_all<0, 2, true>("fp8_fp6"); }
TEST(WmmaF8f6f4_128, Fpsan_Fp4Fp8_mixed) { run_fpsan_all<4, 0, true>("fp4_fp8"); }
TEST(WmmaF8f6f4_128, Fpsan_Bf8Fp4_mixed) { run_fpsan_all<1, 4, true>("bf8_fp4"); }
