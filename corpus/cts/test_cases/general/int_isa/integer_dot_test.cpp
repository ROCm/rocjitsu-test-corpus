...
template <bool ASigned, bool BSigned, bool Clamp>
struct DotIu8Trait
{
    ...
    static void expect(const Output& actual, const Output& expected, std::size_t case_index)
    {
        int_isa_test::expect_equal(
            "sudot4_result_bits", actual.result_bits, expected.result_bits, case_index);
    }
};
...
struct DotIu4Trait
{
    ...
    {
        int_isa_test::expect_equal(
            "sudot8_result_bits", actual.result_bits, expected.result_bits, case_index);
    }
};
