...
namespace fpsan
{
    namespace detail
    {
        ...
        struct Swmmac16x16x128CompressedALayout
        {
            ...
            {
                return row + 16 * ((cc >> 1) & 1);
            }
            FPSAN_DEVICE static int ab_index(int cc)
            {
                return 2 * (cc >> 2) + (cc & 1);
            }
        };
        ...
        FPSAN_DEVICE Value<CVec, S, C> swmmac_software_16x16x128_fp8(Value<AVec, S, C> a,
                                                                     Value<BVec, S, C> b,
                                                                     Value<CVec, S, C> c,
                                                                     v2i32_native      index)
        {
            ...
            for(int e = 0; e < 8; ++e)
            {
                ...
                for(int cc = 0; cc < 64; ++cc)
                {
                    ...
                    const int idxword
                        = __builtin_amdgcn_ds_bpermute(idx_lane * 4, index[idx_dword]);
...
#define FPSAN_DEFINE_SWMMAC_GFX1250_FP8(NAME, AVec_, BVec_, CVec_, BUILTIN)                   \
    ...
    {                                                                                         \
        ...
        {                                                                                     \
            return detail::swmmac_software_16x16x128_fp8<AVec_, BVec_, CVec_, S, C>(          \
                a, b, c, index);                                                              \
        }                                                                                     \
    }

#if !defined(__HIP_DEVICE_COMPILE__) || __has_builtin(__builtin_amdgcn_swmmac_f32_16x16x128_fp8_fp8)
    FPSAN_DEFINE_SWMMAC_GFX1250_FP8(amdgcn_swmmac_f32_16x16x128_fp8_fp8,
                                    v32e4m3_native,
                                    v64e4m3_native,
                                    v8f_native,
                                    __builtin_amdgcn_swmmac_f32_16x16x128_fp8_fp8)
    FPSAN_DEFINE_SWMMAC_GFX1250_FP8(amdgcn_swmmac_f32_16x16x128_fp8_bf8,
                                    v32e4m3_native,
                                    v64e5m2_native,
                                    v8f_native,
                                    __builtin_amdgcn_swmmac_f32_16x16x128_fp8_bf8)
    FPSAN_DEFINE_SWMMAC_GFX1250_FP8(amdgcn_swmmac_f32_16x16x128_bf8_fp8,
                                    v32e5m2_native,
                                    v64e4m3_native,
                                    v8f_native,
                                    __builtin_amdgcn_swmmac_f32_16x16x128_bf8_fp8)
    FPSAN_DEFINE_SWMMAC_GFX1250_FP8(amdgcn_swmmac_f32_16x16x128_bf8_bf8,
                                    v32e5m2_native,
                                    v64e5m2_native,
                                    v8f_native,
                                    __builtin_amdgcn_swmmac_f32_16x16x128_bf8_bf8)
    FPSAN_DEFINE_SWMMAC_GFX1250_FP8(amdgcn_swmmac_f16_16x16x128_fp8_fp8,
                                    v32e4m3_native,
                                    v64e4m3_native,
                                    v8h_native,
                                    __builtin_amdgcn_swmmac_f16_16x16x128_fp8_fp8)
    FPSAN_DEFINE_SWMMAC_GFX1250_FP8(amdgcn_swmmac_f16_16x16x128_fp8_bf8,
                                    v32e4m3_native,
                                    v64e5m2_native,
                                    v8h_native,
                                    __builtin_amdgcn_swmmac_f16_16x16x128_fp8_bf8)
    FPSAN_DEFINE_SWMMAC_GFX1250_FP8(amdgcn_swmmac_f16_16x16x128_bf8_fp8,
                                    v32e5m2_native,
                                    v64e4m3_native,
                                    v8h_native,
                                    __builtin_amdgcn_swmmac_f16_16x16x128_bf8_fp8)
    FPSAN_DEFINE_SWMMAC_GFX1250_FP8(amdgcn_swmmac_f16_16x16x128_bf8_bf8,
                                    v32e5m2_native,
                                    v64e5m2_native,
                                    v8h_native,
...
#define FPSAN_DEFINE_SWMMAC_GFX1250_16(NAME, AVec_, BVec_, CVec_, BUILTIN)                         \
    ...
    FPSAN_DEFINE_SWMMAC_GFX1250_16(amdgcn_swmmac_f32_16x16x64_f16,
                                   v16h_native,
                                   v32h_native,
                                   v8f_native,
                                   __builtin_amdgcn_swmmac_f32_16x16x64_f16)
    FPSAN_DEFINE_SWMMAC_GFX1250_16(amdgcn_swmmac_f16_16x16x64_f16,
                                   v16h_native,
                                   v32h_native,
                                   v8h_native,
                                   __builtin_amdgcn_swmmac_f16_16x16x64_f16)
    FPSAN_DEFINE_SWMMAC_GFX1250_16(amdgcn_swmmac_f32_16x16x64_bf16,
                                   v16bf_native,
                                   v32bf_native,
                                   v8f_native,
                                   __builtin_amdgcn_swmmac_f32_16x16x64_bf16)
    FPSAN_DEFINE_SWMMAC_GFX1250_16(amdgcn_swmmac_bf16_16x16x64_bf16,
                                   v16bf_native,
                                   v32bf_native,
                                   v8bf_native,
                                   __builtin_amdgcn_swmmac_bf16_16x16x64_bf16)
    FPSAN_DEFINE_SWMMAC_GFX1250_16(amdgcn_swmmac_bf16f32_16x16x64_bf16,
                                   v16bf_native,
                                   v32bf_native,
                                   v8f_native,
