...
FPSAN_DEVICE Value<v2h_native, S, C> amdgcn_cvt_pkrtz(Value<float, S, C> a, Value<float, S, C> b) {
  ...
  FPSAN_DEVICE int name(Value<float, S, C> a, Value<float, S, C> b, int old) {                     \
   ...
   different words -- a silent cross-mode inconsistency.) */                                       \
      ...
      return detail::pack_fp8_pair<DstLo>(static_cast<std::uint8_t>(af.fpsan_payload()),           \
                                          static_cast<std::uint8_t>(bf.fpsan_payload()), old);     \
    }                                                                                              \
  }
...
#define FPSAN_DEFINE_CVT_PK_F32_FP8(name, FP8, BUILTIN)                                            \
  ...
  FPSAN_DEVICE Value<v2f_native, S, C> name(int packed) {                                          \
    if constexpr (S == Semantics::Native) {                                                        \
      ...
      r.set(0, fpsan::cast<float>(detail::unpack_byte_to_fp8<2 * WordSel, FP8, S, C>(packed)));    \
      r.set(1,                                                                                     \
            fpsan::cast<float>(detail::unpack_byte_to_fp8<2 * WordSel + 1, FP8, S, C>(packed)));   \
      return r;                                                                                    \
    }                                                                                              \
  }
...
namespace detail {
template <int ByteIdx> FPSAN_DEVICE int splice_fp8_byte(std::uint8_t byte, int old) {
...
template <bool DstLo, Semantics S = Semantics::Native, Conversions C = Conversions::Explicit>
FPSAN_DEVICE Value<v2h_native, S, C>
amdgcn_cvt_sr_f16_f32(Value<v2h_native, S, C> old, Value<float, S, C> val, std::uint32_t seed) {
  if constexpr (S == Semantics::Native) {
    v2h_native r =
...
template <bool DstLo, Semantics S = Semantics::Native, Conversions C = Conversions::Explicit>
FPSAN_DEVICE Value<v2bf_native, S, C>
amdgcn_cvt_sr_bf16_f32(Value<v2bf_native, S, C> old, Value<float, S, C> val, std::uint32_t seed) {
  if constexpr (S == Semantics::Native) {
    v2bf_native r = __builtin_amdgcn_cvt_sr_bf16_f32(old.to_float(), val.to_float(), seed,
                                                     DstLo ? false : true);
...
template <int ByteIdx, Semantics S = Semantics::Native, Conversions C = Conversions::Explicit>
FPSAN_DEVICE Value<float, S, C> amdgcn_cvt_scalef32_f32_fp8(int packed, Value<float, S, C> scale) {
  if constexpr (S == Semantics::Native)
...
template <int ByteIdx, Semantics S = Semantics::Native, Conversions C = Conversions::Explicit>
FPSAN_DEVICE Value<float, S, C> amdgcn_cvt_scalef32_f32_bf8(int packed, Value<float, S, C> scale) {
  if constexpr (S == Semantics::Native)
    return Value<float, S, C>(
...
#define FPSAN_DEFINE_CVT_SCALEF32_F16_FP8(NAME, FP8, BUILTIN)                                      \
  template <int ByteIdx, bool Hi, Semantics S = Semantics::Native,                                 \
            Conversions C = Conversions::Explicit>                                                 \
  FPSAN_DEVICE Value<v2h_native, S, C> NAME(Value<v2h_native, S, C> old, int src,                  \
...
FPSAN_DEFINE_CVT_SCALEF32_F16_FP8(amdgcn_cvt_scalef32_f16_fp8, fp8_e4m3,
                                  __builtin_amdgcn_cvt_scalef32_f16_fp8)
FPSAN_DEFINE_CVT_SCALEF32_F16_FP8(amdgcn_cvt_scalef32_f16_bf8, fp8_e5m2,
...
template <bool DstLo, Semantics S = Semantics::Native, Conversions C = Conversions::Explicit>
FPSAN_DEVICE int amdgcn_cvt_scalef32_pk_fp8_f32(Value<float, S, C> a, Value<float, S, C> b,
                                                Value<float, S, C> scale, int old) {
  if constexpr (S == Semantics::Native) {
    ...
    const auto r = __builtin_amdgcn_cvt_scalef32_pk_fp8_f32(oldv, a.to_float(), b.to_float(),
                                                            scale.to_float(), !DstLo);
...
template <bool DstLo, Semantics S = Semantics::Native, Conversions C = Conversions::Explicit>
FPSAN_DEVICE int amdgcn_cvt_scalef32_pk_bf8_f32(Value<float, S, C> a, Value<float, S, C> b,
                                                Value<float, S, C> scale, int old) {
  if constexpr (S == Semantics::Native) {
    const auto oldv = __builtin_bit_cast(v2s16_native, old);
    const auto r = __builtin_amdgcn_cvt_scalef32_pk_bf8_f32(oldv, a.to_float(), b.to_float(),
                                                            scale.to_float(), !DstLo);
    return __builtin_bit_cast(int, r);
  } else {
...
FPSAN_DEFINE_CVT_SCALEF32_UNPACK_FP8(amdgcn_cvt_scalef32_pk_f32_fp8, fp8_e4m3, float, v2f_native,
                                     __builtin_amdgcn_cvt_scalef32_pk_f32_fp8)
FPSAN_DEFINE_CVT_SCALEF32_UNPACK_FP8(amdgcn_cvt_scalef32_pk_f32_bf8, fp8_e5m2, float, v2f_native,
                                     __builtin_amdgcn_cvt_scalef32_pk_f32_bf8)
FPSAN_DEFINE_CVT_SCALEF32_UNPACK_FP8(amdgcn_cvt_scalef32_pk_f16_fp8, fp8_e4m3, _Float16, v2h_native,
                                     __builtin_amdgcn_cvt_scalef32_pk_f16_fp8)
FPSAN_DEFINE_CVT_SCALEF32_UNPACK_FP8(amdgcn_cvt_scalef32_pk_f16_bf8, fp8_e5m2, _Float16, v2h_native,
                                     __builtin_amdgcn_cvt_scalef32_pk_f16_bf8)
FPSAN_DEFINE_CVT_SCALEF32_UNPACK_FP8(amdgcn_cvt_scalef32_pk_bf16_fp8, fp8_e4m3, __bf16, v2bf_native,
                                     __builtin_amdgcn_cvt_scalef32_pk_bf16_fp8)
FPSAN_DEFINE_CVT_SCALEF32_UNPACK_FP8(amdgcn_cvt_scalef32_pk_bf16_bf8, fp8_e5m2, __bf16, v2bf_native,
...
FPSAN_DEFINE_CVT_SCALEF32_PACK_FP8(amdgcn_cvt_scalef32_pk_fp8_f16, fp8_e4m3, v2h_native,
                                   __builtin_amdgcn_cvt_scalef32_pk_fp8_f16)
FPSAN_DEFINE_CVT_SCALEF32_PACK_FP8(amdgcn_cvt_scalef32_pk_fp8_bf16, fp8_e4m3, v2bf_native,
                                   __builtin_amdgcn_cvt_scalef32_pk_fp8_bf16)
FPSAN_DEFINE_CVT_SCALEF32_PACK_FP8(amdgcn_cvt_scalef32_pk_bf8_f16, fp8_e5m2, v2h_native,
                                   __builtin_amdgcn_cvt_scalef32_pk_bf8_f16)
FPSAN_DEFINE_CVT_SCALEF32_PACK_FP8(amdgcn_cvt_scalef32_pk_bf8_bf16, fp8_e5m2, v2bf_native,
...
#define FPSAN_DEFINE_CVT_SCALEF32_SR_FP8(NAME, FP8, SRC, BUILTIN)                                  \
  template <int ByteIdx, Semantics S = Semantics::Native, Conversions C = Conversions::Explicit>   \
  FPSAN_DEVICE int NAME(int old, Value<SRC, S, C> val, std::uint32_t seed,                         \
                        Value<float, S, C> scale) {                                                \
    if constexpr (S == Semantics::Native)                                                          \
...
FPSAN_DEFINE_CVT_SCALEF32_SR_FP8(amdgcn_cvt_scalef32_sr_fp8_f32, fp8_e4m3, float,
                                 __builtin_amdgcn_cvt_scalef32_sr_fp8_f32)
FPSAN_DEFINE_CVT_SCALEF32_SR_FP8(amdgcn_cvt_scalef32_sr_fp8_f16, fp8_e4m3, _Float16,
                                 __builtin_amdgcn_cvt_scalef32_sr_fp8_f16)
FPSAN_DEFINE_CVT_SCALEF32_SR_FP8(amdgcn_cvt_scalef32_sr_fp8_bf16, fp8_e4m3, __bf16,
                                 __builtin_amdgcn_cvt_scalef32_sr_fp8_bf16)
FPSAN_DEFINE_CVT_SCALEF32_SR_FP8(amdgcn_cvt_scalef32_sr_bf8_f32, fp8_e5m2, float,
                                 __builtin_amdgcn_cvt_scalef32_sr_bf8_f32)
FPSAN_DEFINE_CVT_SCALEF32_SR_FP8(amdgcn_cvt_scalef32_sr_bf8_f16, fp8_e5m2, _Float16,
                                 __builtin_amdgcn_cvt_scalef32_sr_bf8_f16)
FPSAN_DEFINE_CVT_SCALEF32_SR_FP8(amdgcn_cvt_scalef32_sr_bf8_bf16, fp8_e5m2, __bf16,
...
template <int Sel>
FPSAN_DEVICE std::uint32_t splice_fp4_pair(std::uint32_t a4, std::uint32_t b4, std::uint32_t old) {
...
FPSAN_DEFINE_CVT_SCALEF32_UNPACK_FP4(amdgcn_cvt_scalef32_pk_f32_fp4, float, v2f_native,
                                     __builtin_amdgcn_cvt_scalef32_pk_f32_fp4)
FPSAN_DEFINE_CVT_SCALEF32_UNPACK_FP4(amdgcn_cvt_scalef32_pk_f16_fp4, _Float16, v2h_native,
                                     __builtin_amdgcn_cvt_scalef32_pk_f16_fp4)
FPSAN_DEFINE_CVT_SCALEF32_UNPACK_FP4(amdgcn_cvt_scalef32_pk_bf16_fp4, __bf16, v2bf_native,
...
template <int Sel, Semantics S = Semantics::Native, Conversions C = Conversions::Explicit>
FPSAN_DEVICE std::uint32_t amdgcn_cvt_scalef32_pk_fp4_f32(std::uint32_t old, Value<float, S, C> a,
                                                          Value<float, S, C> b,
                                                          Value<float, S, C> scale) {
  if constexpr (S == Semantics::Native)
    return __builtin_amdgcn_cvt_scalef32_pk_fp4_f32(old, a.to_float(), b.to_float(),
                                                    scale.to_float(), Sel);
  else
...
#define FPSAN_DEFINE_CVT_SCALEF32_PACK_FP4(NAME, SrcFT, VEC, BUILTIN)                              \
  template <int Sel, Semantics S = Semantics::Native, Conversions C = Conversions::Explicit>       \
  FPSAN_DEVICE std::uint32_t NAME(std::uint32_t old, Value<VEC, S, C> v,                           \
                                  Value<float, S, C> scale) {                                      \
    if constexpr (S == Semantics::Native) {                                                        \
      ...
      const auto a = fpsan::cast<float>(v.get(0)) / scale;                                         \
      const auto b = fpsan::cast<float>(v.get(1)) / scale;                                         \
      return detail::splice_fp4_pair<Sel>(detail::f32_to_fp4_nibble<S, C>(a),                      \
                                          detail::f32_to_fp4_nibble<S, C>(b), old);                \
    }                                                                                              \
  }
FPSAN_DEFINE_CVT_SCALEF32_PACK_FP4(amdgcn_cvt_scalef32_pk_fp4_f16, _Float16, v2h_native,
                                   __builtin_amdgcn_cvt_scalef32_pk_fp4_f16)
FPSAN_DEFINE_CVT_SCALEF32_PACK_FP4(amdgcn_cvt_scalef32_pk_fp4_bf16, __bf16, v2bf_native,
...
amdgcn_cvt_scalef32_sr_pk_fp4_f32(std::uint32_t old, Value<float, S, C> a, Value<float, S, C> b,
                                  std::uint32_t seed, Value<float, S, C> scale) {
  if constexpr (S == Semantics::Native) {
...
#define FPSAN_DEFINE_CVT_SCALEF32_SR_PK_FP4(NAME, VEC, BUILTIN)                                    \
  template <int Sel, Semantics S = Semantics::Native, Conversions C = Conversions::Explicit>       \
  FPSAN_DEVICE std::uint32_t NAME(std::uint32_t old, Value<VEC, S, C> v, std::uint32_t seed,       \
                                  Value<float, S, C> scale) {                                      \
    if constexpr (S == Semantics::Native) {                                                        \
...
FPSAN_DEFINE_CVT_SCALEF32_SR_PK_FP4(amdgcn_cvt_scalef32_sr_pk_fp4_f16, v2h_native,
                                    __builtin_amdgcn_cvt_scalef32_sr_pk_fp4_f16)
FPSAN_DEFINE_CVT_SCALEF32_SR_PK_FP4(amdgcn_cvt_scalef32_sr_pk_fp4_bf16, v2bf_native,
...
template <class V> FPSAN_DEVICE inline std::uint32_t extract6(const V &w, int i) {
...
template <class V> FPSAN_DEVICE inline void insert6(V &w, int i, std::uint32_t v6) {
  v6 &= 0x3Fu;
  const int p = i * 6, wi = p >> 5, off = p & 31;
  w[wi] |= v6 << off;
  if (off > 26)
...
// semantics.
template <Semantics S, Conversions C> FPSAN_DEVICE Value<float, S, C> sub6_to_f32(std::uint32_t f) {
  return subbyte_widen_to<float, 6, S, C>(f);
}
template <Semantics S, Conversions C> FPSAN_DEVICE std::uint32_t f32_to_sub6(Value<float, S, C> v) {
...
#define FPSAN_DEFINE_CVT_SCALEF32_UNPACK_PK32(NAME, DstFT, VEC, BUILTIN)                           \
  ...
  FPSAN_DEVICE Value<VEC, S, C> NAME(v6u32_native packed, Value<float, S, C> scale) {              \
    if constexpr (S == Semantics::Native) {                                                        \
      ...
      for (int i = 0; i < 32; ++i)                                                                 \
        r.set(i,                                                                                   \
              fpsan::cast<DstFT>(detail::sub6_to_f32<S, C>(detail::extract6(packed, i)) * scale)); \
      return r;                                                                                    \
    }                                                                                              \
  }
FPSAN_DEFINE_CVT_SCALEF32_UNPACK_PK32(amdgcn_cvt_scalef32_pk32_f32_fp6, float, v32f_native,
                                      __builtin_amdgcn_cvt_scalef32_pk32_f32_fp6)
FPSAN_DEFINE_CVT_SCALEF32_UNPACK_PK32(amdgcn_cvt_scalef32_pk32_f32_bf6, float, v32f_native,
                                      __builtin_amdgcn_cvt_scalef32_pk32_f32_bf6)
FPSAN_DEFINE_CVT_SCALEF32_UNPACK_PK32(amdgcn_cvt_scalef32_pk32_f16_fp6, _Float16, v32h_native,
                                      __builtin_amdgcn_cvt_scalef32_pk32_f16_fp6)
FPSAN_DEFINE_CVT_SCALEF32_UNPACK_PK32(amdgcn_cvt_scalef32_pk32_f16_bf6, _Float16, v32h_native,
                                      __builtin_amdgcn_cvt_scalef32_pk32_f16_bf6)
FPSAN_DEFINE_CVT_SCALEF32_UNPACK_PK32(amdgcn_cvt_scalef32_pk32_bf16_fp6, __bf16, v32bf_native,
                                      __builtin_amdgcn_cvt_scalef32_pk32_bf16_fp6)
FPSAN_DEFINE_CVT_SCALEF32_UNPACK_PK32(amdgcn_cvt_scalef32_pk32_bf16_bf6, __bf16, v32bf_native,
...
#define FPSAN_DEFINE_CVT_SCALEF32_2XPK16(NAME, BUILTIN)                                            \
  template <Semantics S = Semantics::Native, Conversions C = Conversions::Explicit>                \
  FPSAN_DEVICE v6u32_native NAME(Value<v16f_native_cvt, S, C> lo, Value<v16f_native_cvt, S, C> hi, \
                                 Value<float, S, C> scale) {                                       \
    if constexpr (S == Semantics::Native) {                                                        \
...
FPSAN_DEFINE_CVT_SCALEF32_PK32_PACK(amdgcn_cvt_scalef32_pk32_fp6_f16, _Float16, v32h_native,
                                    __builtin_amdgcn_cvt_scalef32_pk32_fp6_f16)
FPSAN_DEFINE_CVT_SCALEF32_PK32_PACK(amdgcn_cvt_scalef32_pk32_bf6_f16, _Float16, v32h_native,
                                    __builtin_amdgcn_cvt_scalef32_pk32_bf6_f16)
FPSAN_DEFINE_CVT_SCALEF32_PK32_PACK(amdgcn_cvt_scalef32_pk32_fp6_bf16, __bf16, v32bf_native,
                                    __builtin_amdgcn_cvt_scalef32_pk32_fp6_bf16)
FPSAN_DEFINE_CVT_SCALEF32_PK32_PACK(amdgcn_cvt_scalef32_pk32_bf6_bf16, __bf16, v32bf_native,
...
#define FPSAN_DEFINE_CVT_SCALEF32_SR_PK32(NAME, BUILTIN)                                           \
  template <Semantics S = Semantics::Native, Conversions C = Conversions::Explicit>                \
  FPSAN_DEVICE v6u32_native NAME(Value<v32f_native, S, C> v, std::uint32_t seed,                   \
                                 Value<float, S, C> scale) {                                       \
    if constexpr (S == Semantics::Native) {                                                        \
...
#define FPSAN_DEFINE_CVT_SCALEF32_SR_PK32_SRC(NAME, VEC, BUILTIN)                                  \
  template <Semantics S = Semantics::Native, Conversions C = Conversions::Explicit>                \
  FPSAN_DEVICE v6u32_native NAME(Value<VEC, S, C> v, std::uint32_t seed,                           \
                                 Value<float, S, C> scale) {                                       \
    if constexpr (S == Semantics::Native) {                                                        \
      return BUILTIN(v.to_float(), seed, scale.to_float());                                        \
    } else {                                                                                       \
...
FPSAN_DEFINE_CVT_SCALEF32_SR_PK32_SRC(amdgcn_cvt_scalef32_sr_pk32_fp6_f16, v32h_native,
                                      __builtin_amdgcn_cvt_scalef32_sr_pk32_fp6_f16)
FPSAN_DEFINE_CVT_SCALEF32_SR_PK32_SRC(amdgcn_cvt_scalef32_sr_pk32_fp6_bf16, v32bf_native,
                                      __builtin_amdgcn_cvt_scalef32_sr_pk32_fp6_bf16)
FPSAN_DEFINE_CVT_SCALEF32_SR_PK32_SRC(amdgcn_cvt_scalef32_sr_pk32_bf6_f16, v32h_native,
                                      __builtin_amdgcn_cvt_scalef32_sr_pk32_bf6_f16)
FPSAN_DEFINE_CVT_SCALEF32_SR_PK32_SRC(amdgcn_cvt_scalef32_sr_pk32_bf6_bf16, v32bf_native,
...
FPSAN_DEFINE_CVT_SCALEF32_PK8_FP8(amdgcn_cvt_scalef32_pk8_fp8_f32, fp8_e4m3, v8f_native,
                                  __builtin_amdgcn_cvt_scalef32_pk8_fp8_f32)
FPSAN_DEFINE_CVT_SCALEF32_PK8_FP8(amdgcn_cvt_scalef32_pk8_bf8_f32, fp8_e5m2, v8f_native,
                                  __builtin_amdgcn_cvt_scalef32_pk8_bf8_f32)
FPSAN_DEFINE_CVT_SCALEF32_PK8_FP8(amdgcn_cvt_scalef32_pk8_fp8_f16, fp8_e4m3, v8h_native,
                                  __builtin_amdgcn_cvt_scalef32_pk8_fp8_f16)
FPSAN_DEFINE_CVT_SCALEF32_PK8_FP8(amdgcn_cvt_scalef32_pk8_bf8_f16, fp8_e5m2, v8h_native,
                                  __builtin_amdgcn_cvt_scalef32_pk8_bf8_f16)
FPSAN_DEFINE_CVT_SCALEF32_PK8_FP8(amdgcn_cvt_scalef32_pk8_fp8_bf16, fp8_e4m3, v8bf_native,
                                  __builtin_amdgcn_cvt_scalef32_pk8_fp8_bf16)
FPSAN_DEFINE_CVT_SCALEF32_PK8_FP8(amdgcn_cvt_scalef32_pk8_bf8_bf16, fp8_e5m2, v8bf_native,
...
FPSAN_DEFINE_CVT_SCALEF32_PK8_FP4(amdgcn_cvt_scalef32_pk8_fp4_f32, v8f_native,
                                  __builtin_amdgcn_cvt_scalef32_pk8_fp4_f32)
FPSAN_DEFINE_CVT_SCALEF32_PK8_FP4(amdgcn_cvt_scalef32_pk8_fp4_f16, v8h_native,
                                  __builtin_amdgcn_cvt_scalef32_pk8_fp4_f16)
FPSAN_DEFINE_CVT_SCALEF32_PK8_FP4(amdgcn_cvt_scalef32_pk8_fp4_bf16, v8bf_native,
...
FPSAN_DEFINE_CVT_SCALEF32_PK16_FP6(amdgcn_cvt_scalef32_pk16_fp6_f32, v16f_native_cvt,
                                   __builtin_amdgcn_cvt_scalef32_pk16_fp6_f32)
FPSAN_DEFINE_CVT_SCALEF32_PK16_FP6(amdgcn_cvt_scalef32_pk16_bf6_f32, v16f_native_cvt,
                                   __builtin_amdgcn_cvt_scalef32_pk16_bf6_f32)
FPSAN_DEFINE_CVT_SCALEF32_PK16_FP6(amdgcn_cvt_scalef32_pk16_fp6_f16, v16h_native,
                                   __builtin_amdgcn_cvt_scalef32_pk16_fp6_f16)
FPSAN_DEFINE_CVT_SCALEF32_PK16_FP6(amdgcn_cvt_scalef32_pk16_bf6_f16, v16h_native,
                                   __builtin_amdgcn_cvt_scalef32_pk16_bf6_f16)
FPSAN_DEFINE_CVT_SCALEF32_PK16_FP6(amdgcn_cvt_scalef32_pk16_fp6_bf16, v16bf_native,
                                   __builtin_amdgcn_cvt_scalef32_pk16_fp6_bf16)
FPSAN_DEFINE_CVT_SCALEF32_PK16_FP6(amdgcn_cvt_scalef32_pk16_bf6_bf16, v16bf_native,
...
#define FPSAN_DEFINE_CVT_SCALEF32_SR_PK8_FP8(NAME, FP8, VEC, BUILTIN)                              \
  template <Semantics S = Semantics::Native, Conversions C = Conversions::Explicit>                \
  FPSAN_DEVICE v2u32_native NAME(Value<VEC, S, C> v, std::uint32_t seed,                           \
                                 Value<float, S, C> scale) {                                       \
    if constexpr (S == Semantics::Native)                                                          \
      return BUILTIN(v.to_float(), seed, scale.to_float());                                        \
    else {                                                                                         \
...
FPSAN_DEFINE_CVT_SCALEF32_SR_PK8_FP8(amdgcn_cvt_scalef32_sr_pk8_fp8_f32, fp8_e4m3, v8f_native,
                                     __builtin_amdgcn_cvt_scalef32_sr_pk8_fp8_f32)
FPSAN_DEFINE_CVT_SCALEF32_SR_PK8_FP8(amdgcn_cvt_scalef32_sr_pk8_bf8_f32, fp8_e5m2, v8f_native,
                                     __builtin_amdgcn_cvt_scalef32_sr_pk8_bf8_f32)
FPSAN_DEFINE_CVT_SCALEF32_SR_PK8_FP8(amdgcn_cvt_scalef32_sr_pk8_fp8_f16, fp8_e4m3, v8h_native,
                                     __builtin_amdgcn_cvt_scalef32_sr_pk8_fp8_f16)
FPSAN_DEFINE_CVT_SCALEF32_SR_PK8_FP8(amdgcn_cvt_scalef32_sr_pk8_bf8_f16, fp8_e5m2, v8h_native,
                                     __builtin_amdgcn_cvt_scalef32_sr_pk8_bf8_f16)
FPSAN_DEFINE_CVT_SCALEF32_SR_PK8_FP8(amdgcn_cvt_scalef32_sr_pk8_fp8_bf16, fp8_e4m3, v8bf_native,
                                     __builtin_amdgcn_cvt_scalef32_sr_pk8_fp8_bf16)
FPSAN_DEFINE_CVT_SCALEF32_SR_PK8_FP8(amdgcn_cvt_scalef32_sr_pk8_bf8_bf16, fp8_e5m2, v8bf_native,
...
#define FPSAN_DEFINE_CVT_SCALEF32_SR_PK8_FP4(NAME, VEC, BUILTIN)                                   \
  template <Semantics S = Semantics::Native, Conversions C = Conversions::Explicit>                \
  FPSAN_DEVICE std::uint32_t NAME(Value<VEC, S, C> v, std::uint32_t seed,                          \
                                  Value<float, S, C> scale) {                                      \
    if constexpr (S == Semantics::Native)                                                          \
      return BUILTIN(v.to_float(), seed, scale.to_float());                                        \
    else {                                                                                         \
...
FPSAN_DEFINE_CVT_SCALEF32_SR_PK8_FP4(amdgcn_cvt_scalef32_sr_pk8_fp4_f32, v8f_native,
                                     __builtin_amdgcn_cvt_scalef32_sr_pk8_fp4_f32)
FPSAN_DEFINE_CVT_SCALEF32_SR_PK8_FP4(amdgcn_cvt_scalef32_sr_pk8_fp4_f16, v8h_native,
                                     __builtin_amdgcn_cvt_scalef32_sr_pk8_fp4_f16)
FPSAN_DEFINE_CVT_SCALEF32_SR_PK8_FP4(amdgcn_cvt_scalef32_sr_pk8_fp4_bf16, v8bf_native,
...
#define FPSAN_DEFINE_CVT_SCALEF32_SR_PK16_FP6(NAME, VEC, BUILTIN)                                  \
  template <Semantics S = Semantics::Native, Conversions C = Conversions::Explicit>                \
  FPSAN_DEVICE v3u32_native NAME(Value<VEC, S, C> v, std::uint32_t seed,                           \
                                 Value<float, S, C> scale) {                                       \
    if constexpr (S == Semantics::Native)                                                          \
      return BUILTIN(v.to_float(), seed, scale.to_float());                                        \
    else {                                                                                         \
...
FPSAN_DEFINE_CVT_SCALEF32_SR_PK16_FP6(amdgcn_cvt_scalef32_sr_pk16_fp6_f32, v16f_native_cvt,
                                      __builtin_amdgcn_cvt_scalef32_sr_pk16_fp6_f32)
FPSAN_DEFINE_CVT_SCALEF32_SR_PK16_FP6(amdgcn_cvt_scalef32_sr_pk16_bf6_f32, v16f_native_cvt,
                                      __builtin_amdgcn_cvt_scalef32_sr_pk16_bf6_f32)
FPSAN_DEFINE_CVT_SCALEF32_SR_PK16_FP6(amdgcn_cvt_scalef32_sr_pk16_fp6_f16, v16h_native,
                                      __builtin_amdgcn_cvt_scalef32_sr_pk16_fp6_f16)
FPSAN_DEFINE_CVT_SCALEF32_SR_PK16_FP6(amdgcn_cvt_scalef32_sr_pk16_bf6_f16, v16h_native,
                                      __builtin_amdgcn_cvt_scalef32_sr_pk16_bf6_f16)
FPSAN_DEFINE_CVT_SCALEF32_SR_PK16_FP6(amdgcn_cvt_scalef32_sr_pk16_fp6_bf16, v16bf_native,
                                      __builtin_amdgcn_cvt_scalef32_sr_pk16_fp6_bf16)
FPSAN_DEFINE_CVT_SCALEF32_SR_PK16_FP6(amdgcn_cvt_scalef32_sr_pk16_bf6_bf16, v16bf_native,
...
FPSAN_DEVICE Value<float, S, C> amdgcn_cvt_f32_fp8_e5m3(int packed) {
  if constexpr (S == Semantics::Native)
    ...
    const std::uint8_t byte =
        static_cast<std::uint8_t>((static_cast<std::uint32_t>(packed) >> (ByteIdx * 8)) & 0xFFu);
...
FPSAN_DEVICE int amdgcn_cvt_pk_fp8_f32_e5m3(Value<float, S, C> a, Value<float, S, C> b, int old) {
  if constexpr (S == Semantics::Native)
    ...
    return detail::pack_fp8_pair<DstLo>(static_cast<std::uint8_t>(a.fpsan_payload()),
                                        static_cast<std::uint8_t>(b.fpsan_payload()), old);
}
#endif
...
template <int ByteIdx, Semantics S = Semantics::Native, Conversions C = Conversions::Explicit>
FPSAN_DEVICE int amdgcn_cvt_sr_fp8_f32_e5m3(Value<float, S, C> val, int packed_old,
                                            std::uint32_t seed) {
  if constexpr (S == Semantics::Native)
...
#define FPSAN_DEFINE_CVT_SCALE_UNPACK_PK8_FP8(NAME, SrcFT, DstFT, VEC, BUILTIN)                    \
  template <int ScaleSel, Semantics S = Semantics::Native, Conversions C = Conversions::Explicit>  \
...
FPSAN_DEFINE_CVT_SCALE_UNPACK_PK8_FP8(amdgcn_cvt_scale_pk8_f32_fp8, fp8_e4m3, float, v8f_native,
                                      __builtin_amdgcn_cvt_scale_pk8_f32_fp8)
FPSAN_DEFINE_CVT_SCALE_UNPACK_PK8_FP8(amdgcn_cvt_scale_pk8_f32_bf8, fp8_e5m2, float, v8f_native,
                                      __builtin_amdgcn_cvt_scale_pk8_f32_bf8)
FPSAN_DEFINE_CVT_SCALE_UNPACK_PK8_FP8(amdgcn_cvt_scale_pk8_f16_fp8, fp8_e4m3, _Float16, v8h_native,
                                      __builtin_amdgcn_cvt_scale_pk8_f16_fp8)
FPSAN_DEFINE_CVT_SCALE_UNPACK_PK8_FP8(amdgcn_cvt_scale_pk8_f16_bf8, fp8_e5m2, _Float16, v8h_native,
                                      __builtin_amdgcn_cvt_scale_pk8_f16_bf8)
FPSAN_DEFINE_CVT_SCALE_UNPACK_PK8_FP8(amdgcn_cvt_scale_pk8_bf16_fp8, fp8_e4m3, __bf16, v8bf_native,
                                      __builtin_amdgcn_cvt_scale_pk8_bf16_fp8)
FPSAN_DEFINE_CVT_SCALE_UNPACK_PK8_FP8(amdgcn_cvt_scale_pk8_bf16_bf8, fp8_e5m2, __bf16, v8bf_native,
  ...
  FPSAN_DEVICE Value<VEC, S, C> NAME(std::uint32_t packed, std::uint32_t scale) {                  \
    if constexpr (S == Semantics::Native)                                                          \
      ...
      for (int i = 0; i < 8; ++i) {                                                                \
        ...
        r.set(i, detail::subbyte_widen_to<DstFT, 4, S, C>(nib));                                   \
      }                                                                                            \
      return r;                                                                                    \
    }                                                                                              \
  }
FPSAN_DEFINE_CVT_SCALE_UNPACK_PK8_FP4(amdgcn_cvt_scale_pk8_f32_fp4, float, v8f_native,
                                      __builtin_amdgcn_cvt_scale_pk8_f32_fp4)
FPSAN_DEFINE_CVT_SCALE_UNPACK_PK8_FP4(amdgcn_cvt_scale_pk8_f16_fp4, _Float16, v8h_native,
                                      __builtin_amdgcn_cvt_scale_pk8_f16_fp4)
FPSAN_DEFINE_CVT_SCALE_UNPACK_PK8_FP4(amdgcn_cvt_scale_pk8_bf16_fp4, __bf16, v8bf_native,
  ...
  FPSAN_DEVICE Value<VEC, S, C> NAME(v3u32_native packed, std::uint32_t scale) {                   \
    if constexpr (S == Semantics::Native)                                                          \
      ...
      for (int i = 0; i < 16; ++i) {                                                               \
        ...
        r.set(i, detail::subbyte_widen_to<DstFT, 6, S, C>(f & 0x3Fu));                             \
      }                                                                                            \
      return r;                                                                                    \
    }                                                                                              \
  }
FPSAN_DEFINE_CVT_SCALE_UNPACK_PK16_FP6(amdgcn_cvt_scale_pk16_f32_fp6, float, v16f_native_cvt,
                                       __builtin_amdgcn_cvt_scale_pk16_f32_fp6)
FPSAN_DEFINE_CVT_SCALE_UNPACK_PK16_FP6(amdgcn_cvt_scale_pk16_f32_bf6, float, v16f_native_cvt,
                                       __builtin_amdgcn_cvt_scale_pk16_f32_bf6)
FPSAN_DEFINE_CVT_SCALE_UNPACK_PK16_FP6(amdgcn_cvt_scale_pk16_f16_fp6, _Float16, v16h_native,
                                       __builtin_amdgcn_cvt_scale_pk16_f16_fp6)
FPSAN_DEFINE_CVT_SCALE_UNPACK_PK16_FP6(amdgcn_cvt_scale_pk16_f16_bf6, _Float16, v16h_native,
                                       __builtin_amdgcn_cvt_scale_pk16_f16_bf6)
FPSAN_DEFINE_CVT_SCALE_UNPACK_PK16_FP6(amdgcn_cvt_scale_pk16_bf16_fp6, __bf16, v16bf_native,
                                       __builtin_amdgcn_cvt_scale_pk16_bf16_fp6)
FPSAN_DEFINE_CVT_SCALE_UNPACK_PK16_FP6(amdgcn_cvt_scale_pk16_bf16_bf6, __bf16, v16bf_native,
