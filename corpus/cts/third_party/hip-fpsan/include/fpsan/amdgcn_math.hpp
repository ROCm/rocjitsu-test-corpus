...
template <bool Clamp = false, Semantics S = Semantics::Native,
          Conversions C = Conversions::Explicit>
FPSAN_DEVICE Value<float, S, C> amdgcn_fdot2(Value<v2h_native, S, C> a, Value<v2h_native, S, C> b,
                                             Value<float, S, C> c) {
  if constexpr (S == Semantics::Native) {
...
#define FPSAN_DEFINE_AMDGCN_DOT4_FP8(NAME, AVec, BVec, BUILTIN)                                    \
  template <Semantics S = Semantics::Native, Conversions C = Conversions::Explicit>                \
  FPSAN_DEVICE Value<float, S, C> NAME(Value<AVec, S, C> a, Value<BVec, S, C> b,                   \
                                       Value<float, S, C> c) {                                     \
    if constexpr (S == Semantics::Native) {                                                        \
...
FPSAN_DEFINE_AMDGCN_DOT4_FP8(amdgcn_dot4_f32_fp8_fp8, v4e4m3_native, v4e4m3_native,
                             __builtin_amdgcn_dot4_f32_fp8_fp8)
FPSAN_DEFINE_AMDGCN_DOT4_FP8(amdgcn_dot4_f32_fp8_bf8, v4e4m3_native, v4e5m2_native,
                             __builtin_amdgcn_dot4_f32_fp8_bf8)
FPSAN_DEFINE_AMDGCN_DOT4_FP8(amdgcn_dot4_f32_bf8_fp8, v4e5m2_native, v4e4m3_native,
                             __builtin_amdgcn_dot4_f32_bf8_fp8)
FPSAN_DEFINE_AMDGCN_DOT4_FP8(amdgcn_dot4_f32_bf8_bf8, v4e5m2_native, v4e5m2_native,
...
FPSAN_DEFINE_AMDGCN_DOT4_FP8(amdgcn_dot4_f32_fp8_fp8, v4amd_e4m3_native, v4amd_e4m3_native,
                             __builtin_amdgcn_dot4_f32_fp8_fp8)
FPSAN_DEFINE_AMDGCN_DOT4_FP8(amdgcn_dot4_f32_fp8_bf8, v4amd_e4m3_native, v4amd_e5m2_native,
                             __builtin_amdgcn_dot4_f32_fp8_bf8)
FPSAN_DEFINE_AMDGCN_DOT4_FP8(amdgcn_dot4_f32_bf8_fp8, v4amd_e5m2_native, v4amd_e4m3_native,
                             __builtin_amdgcn_dot4_f32_bf8_fp8)
FPSAN_DEFINE_AMDGCN_DOT4_FP8(amdgcn_dot4_f32_bf8_bf8, v4amd_e5m2_native, v4amd_e5m2_native,
                             __builtin_amdgcn_dot4_f32_bf8_bf8)
#endif
