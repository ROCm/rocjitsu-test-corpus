...
/// @brief rocBLAS SGEMM tests for the kernel corpus.
///
/// Tests important GEMM sizes, non-square dimensions, alpha/beta variants,
/// and random fuzzing. All cases validate against a CPU golden reference.
/// Compiled with HIP and linked against rocBLAS.
///
/// The corpus manifest runs each gtest filter in a fresh process because
/// running multiple HIP dispatches sequentially in one process can hang due to
/// COMGR state issues.
