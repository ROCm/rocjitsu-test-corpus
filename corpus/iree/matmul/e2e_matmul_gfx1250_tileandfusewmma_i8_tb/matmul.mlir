#compilation0 = #iree_codegen.compilation_info<
  lowering_config = #iree_gpu.lowering_config<{  mma_kind = #iree_gpu.mma_layout<WMMA_I32_16x16x64_I8>,   subgroup = [1, 1, 0],     promote_operands = [0, 1],   workgroup = [16, 16, 0],   reduction = [0, 0, 1] }>,
  translation_info = #iree_codegen.translation_info<pipeline = #iree_gpu.pipeline<TileAndFuse> workgroup_size = [32, 1, 1]
  subgroup_size = 32>>
util.func @matmul_accumulate_512x128xi8_times_512x128xi8_into_512x512xi32_for_TileAndFuse(%lhs: tensor<512x128xi8>, %rhs: tensor<512x128xi8>, %acc: tensor<512x512xi32>) -> tensor<512x512xi32> {
...
#compilation1 = #iree_codegen.compilation_info<
  ...
  translation_info = #iree_codegen.translation_info<pipeline = #iree_gpu.pipeline<TileAndFuse> workgroup_size = [32, 1, 1]
  subgroup_size = 32>>
util.func @matmul_512x128xi8_times_512x128xi8_into_512x512xi32_for_TileAndFuse(%lhs: tensor<512x128xi8>, %rhs: tensor<512x128xi8>) -> tensor<512x512xi32> {
