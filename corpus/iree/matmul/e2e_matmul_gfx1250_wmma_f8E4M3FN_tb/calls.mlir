...
util.func private @module.matmul_accumulate_512x128xf8E4M3FN_times_512x128xf8E4M3FN_into_512x512xf32_for_VectorDistribute(%lhs: !hal.buffer_view, %rhs: !hal.buffer_view, %acc: !hal.buffer_view) -> !hal.buffer_view
util.func private @module.matmul_512x128xf8E4M3FN_times_512x128xf8E4M3FN_into_512x512xf32_for_VectorDistribute(%lhs: !hal.buffer_view, %rhs: !hal.buffer_view) -> !hal.buffer_view

util.func @matmul_accumulate_512x128xf8E4M3FN_times_512x128xf8E4M3FN_into_512x512xf32_for_VectorDistribute_512_128_512_acc_0() attributes {
  ...
  %result = util.call @module.matmul_accumulate_512x128xf8E4M3FN_times_512x128xf8E4M3FN_into_512x512xf32_for_VectorDistribute(%lhs, %rhs, %acc) : (!hal.buffer_view, !hal.buffer_view, !hal.buffer_view) -> !hal.buffer_view
...
util.func @matmul_512x128xf8E4M3FN_times_512x128xf8E4M3FN_into_512x512xf32_for_VectorDistribute_512_128_512_1() attributes {
  iree.reflection = {description = "Matmul shape (MxKxN): 512x128x512"}
} {
  %device_index = arith.constant 0 : index
  %device = hal.devices.get %device_index : !hal.device
  ...
  %rhs = util.call @matmul_test.generate_random_matrix(%device, %rhs_dim0, %rhs_dim1, %rhs_element_type, %rhs_seed) : (!hal.device, i64, i64, i32, i32) -> !hal.buffer_view
  %result = util.call @module.matmul_512x128xf8E4M3FN_times_512x128xf8E4M3FN_into_512x512xf32_for_VectorDistribute(%lhs, %rhs) : (!hal.buffer_view, !hal.buffer_view) -> !hal.buffer_view
  %m = arith.constant 512 : i64
  %k = arith.constant 128 : i64
  %n = arith.constant 512 : i64
  %transpose_rhs = arith.constant 1 : i32
...
util.func @matmul_accumulate_512x128xf8E4M3FN_times_512x128xf8E4M3FN_into_512x512xf32_for_VectorDistribute_512_128_512_acc_2() attributes {
  iree.reflection = {description = "Matmul shape (MxKxN): 512x128x512"}
} {
  %device_index = arith.constant 0 : index
  %device = hal.devices.get %device_index : !hal.device
...
util.func @matmul_512x128xf8E4M3FN_times_512x128xf8E4M3FN_into_512x512xf32_for_VectorDistribute_512_128_512_3() attributes {
  iree.reflection = {description = "Matmul shape (MxKxN): 512x128x512"}
} {
  %device_index = arith.constant 0 : index
  %device = hal.devices.get %device_index : !hal.device
...
util.func @matmul_accumulate_512x128xf8E4M3FN_times_512x128xf8E4M3FN_into_512x512xf32_for_VectorDistribute_512_128_512_acc_4() attributes {
  iree.reflection = {description = "Matmul shape (MxKxN): 512x128x512"}
} {
  %device_index = arith.constant 0 : index
  %device = hal.devices.get %device_index : !hal.device
...
util.func @matmul_512x128xf8E4M3FN_times_512x128xf8E4M3FN_into_512x512xf32_for_VectorDistribute_512_128_512_5() attributes {
  iree.reflection = {description = "Matmul shape (MxKxN): 512x128x512"}
} {
  %device_index = arith.constant 0 : index
  %device = hal.devices.get %device_index : !hal.device
...
util.func @matmul_accumulate_512x128xf8E4M3FN_times_512x128xf8E4M3FN_into_512x512xf32_for_VectorDistribute_512_128_512_acc_6() attributes {
  iree.reflection = {description = "Matmul shape (MxKxN): 512x128x512"}
} {
  %device_index = arith.constant 0 : index
  %device = hal.devices.get %device_index : !hal.device
...
util.func @matmul_512x128xf8E4M3FN_times_512x128xf8E4M3FN_into_512x512xf32_for_VectorDistribute_512_128_512_7() attributes {
  iree.reflection = {description = "Matmul shape (MxKxN): 512x128x512"}
} {
  %device_index = arith.constant 0 : index
  %device = hal.devices.get %device_index : !hal.device
...
util.func @matmul_accumulate_512x128xf8E4M3FN_times_512x128xf8E4M3FN_into_512x512xf32_for_VectorDistribute_512_128_512_acc_8() attributes {
  iree.reflection = {description = "Matmul shape (MxKxN): 512x128x512"}
} {
  %device_index = arith.constant 0 : index
  %device = hal.devices.get %device_index : !hal.device
...
util.func @matmul_512x128xf8E4M3FN_times_512x128xf8E4M3FN_into_512x512xf32_for_VectorDistribute_512_128_512_9() attributes {
  iree.reflection = {description = "Matmul shape (MxKxN): 512x128x512"}
} {
  %device_index = arith.constant 0 : index
  %device = hal.devices.get %device_index : !hal.device
...
util.func @matmul_accumulate_512x128xf8E4M3FN_times_512x128xf8E4M3FN_into_512x512xf32_for_VectorDistribute_512_128_512_acc_10() attributes {
  iree.reflection = {description = "Matmul shape (MxKxN): 512x128x512"}
} {
  %device_index = arith.constant 0 : index
  %device = hal.devices.get %device_index : !hal.device
...
util.func @matmul_512x128xf8E4M3FN_times_512x128xf8E4M3FN_into_512x512xf32_for_VectorDistribute_512_128_512_11() attributes {
  iree.reflection = {description = "Matmul shape (MxKxN): 512x128x512"}
} {
  %device_index = arith.constant 0 : index
  %device = hal.devices.get %device_index : !hal.device
...
util.func @matmul_accumulate_512x128xf8E4M3FN_times_512x128xf8E4M3FN_into_512x512xf32_for_VectorDistribute_512_128_512_acc_12() attributes {
  iree.reflection = {description = "Matmul shape (MxKxN): 512x128x512"}
} {
  %device_index = arith.constant 0 : index
  %device = hal.devices.get %device_index : !hal.device
...
util.func @matmul_512x128xf8E4M3FN_times_512x128xf8E4M3FN_into_512x512xf32_for_VectorDistribute_512_128_512_13() attributes {
  iree.reflection = {description = "Matmul shape (MxKxN): 512x128x512"}
} {
  %device_index = arith.constant 0 : index
  %device = hal.devices.get %device_index : !hal.device
...
util.func @matmul_accumulate_512x128xf8E4M3FN_times_512x128xf8E4M3FN_into_512x512xf32_for_VectorDistribute_512_128_512_acc_14() attributes {
  iree.reflection = {description = "Matmul shape (MxKxN): 512x128x512"}
} {
  %device_index = arith.constant 0 : index
  %device = hal.devices.get %device_index : !hal.device
...
util.func @matmul_512x128xf8E4M3FN_times_512x128xf8E4M3FN_into_512x512xf32_for_VectorDistribute_512_128_512_15() attributes {
  iree.reflection = {description = "Matmul shape (MxKxN): 512x128x512"}
} {
  %device_index = arith.constant 0 : index
  %device = hal.devices.get %device_index : !hal.device
...
util.func @matmul_accumulate_512x128xf8E4M3FN_times_512x128xf8E4M3FN_into_512x512xf32_for_VectorDistribute_512_128_512_acc_16() attributes {
  iree.reflection = {description = "Matmul shape (MxKxN): 512x128x512"}
} {
  %device_index = arith.constant 0 : index
  %device = hal.devices.get %device_index : !hal.device
...
util.func @matmul_512x128xf8E4M3FN_times_512x128xf8E4M3FN_into_512x512xf32_for_VectorDistribute_512_128_512_17() attributes {
  iree.reflection = {description = "Matmul shape (MxKxN): 512x128x512"}
} {
  %device_index = arith.constant 0 : index
  %device = hal.devices.get %device_index : !hal.device
...
util.func @matmul_accumulate_512x128xf8E4M3FN_times_512x128xf8E4M3FN_into_512x512xf32_for_VectorDistribute_512_128_512_acc_18() attributes {
  iree.reflection = {description = "Matmul shape (MxKxN): 512x128x512"}
} {
  %device_index = arith.constant 0 : index
  %device = hal.devices.get %device_index : !hal.device
...
util.func @matmul_512x128xf8E4M3FN_times_512x128xf8E4M3FN_into_512x512xf32_for_VectorDistribute_512_128_512_19() attributes {
  iree.reflection = {description = "Matmul shape (MxKxN): 512x128x512"}
} {
  %device_index = arith.constant 0 : index
  %device = hal.devices.get %device_index : !hal.device
...
util.func @matmul_accumulate_512x128xf8E4M3FN_times_512x128xf8E4M3FN_into_512x512xf32_for_VectorDistribute_512_128_512_acc_20() attributes {
  iree.reflection = {description = "Matmul shape (MxKxN): 512x128x512"}
} {
  %device_index = arith.constant 0 : index
  %device = hal.devices.get %device_index : !hal.device
...
util.func @matmul_512x128xf8E4M3FN_times_512x128xf8E4M3FN_into_512x512xf32_for_VectorDistribute_512_128_512_21() attributes {
  iree.reflection = {description = "Matmul shape (MxKxN): 512x128x512"}
} {
  %device_index = arith.constant 0 : index
  %device = hal.devices.get %device_index : !hal.device
...
util.func @matmul_accumulate_512x128xf8E4M3FN_times_512x128xf8E4M3FN_into_512x512xf32_for_VectorDistribute_512_128_512_acc_22() attributes {
  iree.reflection = {description = "Matmul shape (MxKxN): 512x128x512"}
} {
  %device_index = arith.constant 0 : index
  %device = hal.devices.get %device_index : !hal.device
...
util.func @matmul_512x128xf8E4M3FN_times_512x128xf8E4M3FN_into_512x512xf32_for_VectorDistribute_512_128_512_23() attributes {
  iree.reflection = {description = "Matmul shape (MxKxN): 512x128x512"}
} {
  %device_index = arith.constant 0 : index
  %device = hal.devices.get %device_index : !hal.device
...
util.func @matmul_accumulate_512x128xf8E4M3FN_times_512x128xf8E4M3FN_into_512x512xf32_for_VectorDistribute_512_128_512_acc_24() attributes {
  iree.reflection = {description = "Matmul shape (MxKxN): 512x128x512"}
} {
  %device_index = arith.constant 0 : index
  %device = hal.devices.get %device_index : !hal.device
...
util.func @matmul_512x128xf8E4M3FN_times_512x128xf8E4M3FN_into_512x512xf32_for_VectorDistribute_512_128_512_25() attributes {
  iree.reflection = {description = "Matmul shape (MxKxN): 512x128x512"}
} {
  %device_index = arith.constant 0 : index
  %device = hal.devices.get %device_index : !hal.device
...
util.func @matmul_accumulate_512x128xf8E4M3FN_times_512x128xf8E4M3FN_into_512x512xf32_for_VectorDistribute_512_128_512_acc_26() attributes {
  iree.reflection = {description = "Matmul shape (MxKxN): 512x128x512"}
} {
  %device_index = arith.constant 0 : index
  %device = hal.devices.get %device_index : !hal.device
...
util.func @matmul_512x128xf8E4M3FN_times_512x128xf8E4M3FN_into_512x512xf32_for_VectorDistribute_512_128_512_27() attributes {
  iree.reflection = {description = "Matmul shape (MxKxN): 512x128x512"}
} {
  %device_index = arith.constant 0 : index
  %device = hal.devices.get %device_index : !hal.device
