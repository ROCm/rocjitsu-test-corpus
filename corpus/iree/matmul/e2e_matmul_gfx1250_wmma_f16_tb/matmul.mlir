#compilation0 = #iree_codegen.compilation_info<
  ...
  subgroup_size = 32>>
util.func @matmul_accumulate_512x128xf16_times_512x128xf16_into_512x512xf32_for_VectorDistribute(%lhs: tensor<512x128xf16>, %rhs: tensor<512x128xf16>, %acc: tensor<512x512xf32>) -> tensor<512x512xf32> {
...
#compilation1 = #iree_codegen.compilation_info<
  ...
  translation_info = #iree_codegen.translation_info<pipeline = #iree_gpu.pipeline<VectorDistribute> workgroup_size = [32, 1, 1]
  subgroup_size = 32>>
util.func @matmul_512x128xf16_times_512x128xf16_into_512x512xf32_for_VectorDistribute(%lhs: tensor<512x128xf16>, %rhs: tensor<512x128xf16>) -> tensor<512x512xf32> {
