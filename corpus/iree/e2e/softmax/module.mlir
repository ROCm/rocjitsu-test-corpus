func.func @softmax_static_10x256x256xf32() -> tensor<10x256x256xf32> {
  ...
  return %0 : tensor<10x256x256xf32>
}

func.func @softmax_dynamic_10x256x256xf32() -> tensor<10x256x256xf32> {
  ...
  return %result : tensor<10x256x256xf32>
}
